...
require_once './ThinkPHP/Library/Vendor/aliyunDysms/api_sdk/vendor/autoload.php';
...
class SmsDemoController extends Controller{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIwLC5IjAuUWfU"; // AccessKeyId
        $accessKeySecret = "oLSEKTNWWCQgWHcvZKo3PdEhg8C4B5"; // AccessKeySecret
    ...
    public static function sendSms($tel) {
        ...
        // 必填，设置短信接收号码
        $request->setPhoneNumbers($tel);//$tel 为传入的手机号

        // 必填，设置签名名称，应严格按"签名名称"填写，请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/sign
        $request->setSignName("椿龄文化");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_162198030");
     ...
     * @return stdClass
     */
    public static function sendBatchSms($arr) {
        ...
        $request->setPhoneNumberJson(json_encode($arr, JSON_UNESCAPED_UNICODE));//$arr 为批量发送的手机号数组
